...
public class SqliteLockManager : ILockManager, IDisposable
{
    ...
    public SqliteLockManager(SqliteOptions options)
    {
        ...
        CancellationToken cancellationToken = default)
    {
            ...
            activeLocks.Count == 0)
        {
            ...
            command.Parameters.Add(new SqliteParameter("@Id", newLock.Id.AbsoluteUri));
            command.Parameters.Add(new SqliteParameter("@Uri", newLock.Uri.LocalPath));
